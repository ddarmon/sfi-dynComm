...
This work demonstrates that asking the proper question and then crafting a weighting scheme to answer that question is an unavoidable first step to community detection. More generally, this work illustrates that many rich and interesting communities present in online social networks are invisible if no clear idea of community is defined a priori and the use of question-oriented community detection can easily bring all of these communities into the light.
