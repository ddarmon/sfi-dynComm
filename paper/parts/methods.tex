...
In this study the link is directed from the user to the follower because this is the direction in which the information flows.\textbf{[[Josh: Is this the case for all the analysis or just the transfer entropy?]]} The final network consists of 6,917 nodes and 1,481,131 edges.
