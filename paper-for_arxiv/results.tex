...
% 	\caption{The distribution of edge weights for different community types (rows) and weight types (columns). The red,  blue, and magenta values below each distribution indicate the median of weight on intra-, inter-, and mixed-edges, respectively.}
...
\subsection{Demonstration of the Question-Oriented Appraoch}
