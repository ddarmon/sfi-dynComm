...
\begin{figure}[ht]
  \centering
\includegraphics[width=0.50\textwidth]{comm0_labels-mention-retweet_weights-hashtag-ecdf.pdf}
...
Last but not least, it is interesting noticing that in the top ten most influential users (ranked using the total outgoing strength in the activity-based network) we find two users (Ann Tran and Jessica Northey) that were listed by Forbes in the "Top 10 Social Media Influencers".