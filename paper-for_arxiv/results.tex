...
\begin{table}
	\caption{The percentage of intra-, inter-, and multi-edges associated with the coverings for each of the four community types.}
	\centering
	\begin{tabular}{l | r r r}
		Community Type & Intra & Inter & Multi \\
		\hline
...
\begin{figure}[!h]
	...
	\caption{The density of edge weights for different community types (rows) and weight types (columns). The red,  blue, and magenta values below each collection of densities indicate the median of weight on intra-, inter-, and multi-edges, respectively.}
	\label{Fig-distributions_by_types}
\end{figure}
