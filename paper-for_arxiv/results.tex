...
Lastly, it is interesting to note that two of the Forbes ``Top 10 Social Media Influencers", % ranked using the total outgoing strength in the activity-based network, 
 ...
 This does not prove, but suggests that this measure of activity-based or information-theoretic influence may be useful in finding influential members purely based on their temporal tweet history while completely ignoring both tweet content and social class. 
