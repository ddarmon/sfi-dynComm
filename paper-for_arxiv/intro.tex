...
\textcolor{red}{A large body of work exists on methods for automatic detection of communities within networks, among which we recall Girvann and Newman algorithm [32, 33], Infomap [39], Leuven [3], and the recently introduced OSLOM [24].}
