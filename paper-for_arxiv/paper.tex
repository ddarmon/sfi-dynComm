...
Thanks to Cesar Flores, Lu\'is Seoane, Kevin Stadler, Jody Wright, and Nix Barnett for their contributions to preliminary ideas related to this paper and to Michelle Girvan, William Rand, and Aaron Clauset, and Ryan James for their valuable comments and suggestions. Finally, we would like to acknowledge the Santa Fe Institute, where this project began\alert{not sure how to word this last sentence}.
