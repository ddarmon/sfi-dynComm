...
In the previous sections we showed how the communities emerging from the different weightings of the follower-followee network differ quantitatively both at the macro and at the micro scale. Here we present some concrete examples of such different communities, in order to show more precisely the interest of using a multifaceted approach to community detection. We explore this at two scale: firstly at the community level, and then at the individual level.
