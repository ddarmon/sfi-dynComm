...
\begin{enumerate}
\item Form a clear question about what \emph{type} of community under consideration---{\it e.g.,} are we looking for groups of friends? or for groups of people having a common interest?---and then perform community detection with that question in mind.
\item Ask more than one question about the users in a network and perform several rounds of community detection, each of which is aimed at revealing a new facet of the communities present in the network. 
\end{enumerate}
