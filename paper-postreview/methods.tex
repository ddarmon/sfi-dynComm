...
\textit{However, if this measure is to be used in practice (Elisa: What does this mean? We are indeed using it)} a deeper analysis of the effects of binning, the resulting sparsity, and their role in the activity-based community structure should be carried out. 
